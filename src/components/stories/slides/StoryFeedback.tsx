    ...
    <div className="flex flex-col items-center justify-center text-center space-y-10">
      ...
      <div className="animate-fade-up opacity-0">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground">
          Gostou de como apresentamos<span className="text-gradient-coral"> o resumo do seu ano?</span>
        </h2>
      </div>
      ...
      <div className="flex items-center justify-center gap-8 animate-fade-up opacity-0 stagger-2">
        ...
        >
          <ThumbsUp className={`w-12 h-12 transition-colors ${selected === "up" ? "text-white" : "text-foreground"}`} />
        </button>
        ...
        >
          <ThumbsDown
            className={`w-12 h-12 transition-colors ${selected === "down" ? "text-white" : "text-foreground"}`}
          />
        </button>
      </div>
