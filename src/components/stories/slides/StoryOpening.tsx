  ...
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-8">
      ...
      <div className="space-y-2 animate-fade-up opacity-0 stagger-2">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gradient-primary leading-tight">
          Sua Retrospectiva
          <br />
          2025
        </h1>
      ...
      <div className="space-y-4 animate-fade-up opacity-0 stagger-3">
        <p className="text-xl md:text-2xl font-semibold text-foreground">Seu ano em números!</p>
